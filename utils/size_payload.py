...
def simple_size(update, context, item, size_chat_id, size_message_id, share_name_list):
    ...
    simple_size_process(command, size_chat_id, size_message_id, share_name_list)


def simple_size_process(command, size_chat_id, size_message_id, share_name_list):
...
def owner_size(
    size_chat_id, size_message_id, task_id, task_link, endpoint_id, endpoint_name
):
    cloner = _cfg["general"]["cloner"]
    option = "size"
    remote = _cfg["general"]["remote"]
